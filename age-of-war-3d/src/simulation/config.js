// Balance numbers: verbatim ES-module copy of ../age-of-war/js/config.js.
// Authoritative source stays in age-of-war/; this file is regenerated by hand
// when balance changes (never written back).
//
// The simulation runs in the ORIGINAL pixel units (world 2400 wide) so combat
// math stays identical to the 2D game. Rendering converts to metres:
//
//   x_metres = x_px * METERS_PER_PX        (lane axis, 0..24)
//   ground plane y = 0                     (original GROUND_Y collapses to 0;
//                                           original y offsets become heights)
...
export const CONFIG = {
  ...
  DIFFICULTIES: [
    { name: 'Easy', enemyHpMult: 0.9, enemyDmgMult: 0.9, enemyGoldMult: 0.9, aiThinkMult: 1.2 },
...
// Render mapping: original pixel units -> metres (lane axis 0..24).
export const WORLD_METERS = 24;
export const METERS_PER_PX = WORLD_METERS / CONFIG.WORLD.WIDTH;
export const toMeters = (px) => px * METERS_PER_PX;
